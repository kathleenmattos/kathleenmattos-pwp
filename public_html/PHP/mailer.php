...
//	}
	 ...
	 **/
	$name = filter_input(INPUT_POST, "textName", FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
	$email = filter_input(INPUT_POST, "textEmail", FILTER_SANITIZE_EMAIL);
	$subject = filter_input(INPUT_POST, "textSubject", FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
	$message = filter_input(INPUT_POST, "textMessage", FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
