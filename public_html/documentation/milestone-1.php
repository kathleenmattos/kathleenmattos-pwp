...
<html lang="en">
	...
	<body>
		<h1>Kathleen Mattos PWP</h1>
		<h2>Milestone 1</h2>
		<h4>Purpose</h4>
		<p>I would like use this page as a way for potential employers to get to know me and see what I can do.</p>
		<h4>Audience</h4>
		<p>The potential audience for this page will probably be mostly potential employers, but will also include professional peers and other developers.</p>
		<h4>Goal</h4>
		<p>The goal for my PWP would be to aquire full or part-time work.</p>
		<h3>Persona</h3>
		<ul>
